        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountSurname = table.Column<string>(nullable: true),
                    AccountStreet = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetWeight = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PetServices_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PetServices_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                name: "BreedOfPetTypes",
                columns: table => new
                {
                    ID = table.Column<Guid>(nullable: false),
                    BreedName = table.Column<string>(nullable: true),
                    PetTypeId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BreedOfPetTypes", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BreedOfPetTypes_PetTypes_PetTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BreedOfPetTypes_PetTypeId",
                table: "BreedOfPetTypes",
                column: "PetTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetServices_AccountId",
                table: "PetServices",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_PetServices_OrderId",
                table: "PetServices",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PetTypes_PetId",
                table: "PetTypes",
                column: "PetId",
                unique: true);
        }
